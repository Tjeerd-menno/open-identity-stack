...
CutoverReadinessTests loads /security/cutover through the real PostgreSQL-backed API, asserts the missing independent-emergency-proof blocker, and confirms execution remains disabled even after the UI acknowledgement. It never submits a cutover or records proof. The review screenshot is written to the temporary directory at ois-cutover-readiness-e2e/cutover-blocked.png.
