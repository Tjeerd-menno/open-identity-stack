...
| `AllowedCorsOrigins` | Comma-separated browser origins allowed to call the API | Production admin web access |
...
| `OPENIDENTITYSTACK_ENABLE_ADMINWEB` | Disables the admin web in the local AppHost when set to `false` |
