...
public static class ApplicationErrors
{
    ...
    public static readonly DomainError PkceNotAllowed =
        DomainError.Validation("Application.PkceNotAllowed", "PKCE is not available for this application profile.");
    ...
    public static readonly DomainError InvalidClientType =
        DomainError.Validation("Application.InvalidClientType", "Client type is not valid for this application profile.");
    ...
    public static readonly DomainError ConsentNotAllowed =
        DomainError.Validation("Application.ConsentNotAllowed", "Consent is not available for this application profile.");

    public static readonly DomainError ProfileChangeNotAllowed =
        DomainError.Validation("Application.ProfileChangeNotAllowed", "Application profile cannot be changed after creation.");

    public static readonly DomainError ProfileNotAvailable =
        DomainError.Validation("Application.ProfileNotAvailable", "This application profile is not available for administrator-managed configuration.");
