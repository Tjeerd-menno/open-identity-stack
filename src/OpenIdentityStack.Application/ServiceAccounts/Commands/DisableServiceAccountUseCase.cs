...
/// <summary>
/// Use case implementation for disabling service accounts.
/// </summary>
public sealed class DisableServiceAccountUseCase : IDisableServiceAccountUseCase
{
    private readonly IServiceAccountRepository repository;
    private readonly IDateTimeProvider dateTimeProvider;
    private readonly IAuditLog auditLog;

    public DisableServiceAccountUseCase(
    ...
    public async Task<Result> ExecuteAsync(
        ...
        Result disableResult = serviceAccount.Disable(this.dateTimeProvider);
